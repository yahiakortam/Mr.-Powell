...
const QUIZ_QUESTIONS = [
  ...
  // ── 50 new questions ──
  { question: 'What does "fortissimo" mean?',                                                   options: ['Moderately loud', 'Very loud', 'Very soft', 'Moderately soft'],                        correct: 1 },
  { question: 'What does "pianissimo" mean?',                                                   options: ['Very loud', 'Moderately soft', 'Very soft', 'Moderately loud'],                         correct: 2 },
  { question: 'How many notes are in a standard major scale?',                                  options: ['5', '6', '7', '8'],                                                                   correct: 2 },
  { question: 'What does "staccato" mean?',                                                     options: ['Smooth and connected', 'Very loud', 'Short and detached', 'Gradually slower'],          correct: 2 },
  { question: 'What does "legato" mean?',                                                       options: ['Short and detached', 'Smooth and connected', 'Very fast', 'Getting louder'],            correct: 1 },
  { question: 'What does "ritardando" mean?',                                                   options: ['Gradually speeding up', 'Gradually slowing down', 'Getting louder', 'Getting softer'],  correct: 1 },
  { question: 'What does "accelerando" mean?',                                                  options: ['Gradually slowing down', 'Getting louder', 'Gradually speeding up', 'Getting softer'],  correct: 2 },
  { question: 'What does "presto" mean?',                                                       options: ['Slow', 'Moderate', 'Fast', 'Very fast'],                                               correct: 3 },
  { question: 'What does "lento" mean?',                                                        options: ['Very fast', 'Fast', 'Moderate', 'Slow'],                                               correct: 3 },
  { question: 'How many semitones are in an octave?',                                           options: ['8', '10', '12', '14'],                                                                 correct: 2 },
  { question: 'What symbol raises a note by a half step?',                                      options: ['Flat', 'Natural', 'Sharp', 'Tie'],                                                     correct: 2 },
  { question: 'What symbol lowers a note by a half step?',                                      options: ['Flat', 'Sharp', 'Natural', 'Double sharp'],                                            correct: 0 },
  { question: 'How many keys does a standard piano have?',                                      options: ['72', '76', '84', '88'],                                                                correct: 3 },
  { question: 'What does a "fermata" tell you to do?',                                          options: ['Play the note twice', 'Hold the note longer than its value', 'Skip the note', 'Play shorter'], correct: 1 },
  { question: 'What instrument family does the violin belong to?',                              options: ['Woodwinds', 'Strings', 'Brass', 'Percussion'],                                         correct: 1 },
  { question: 'What instrument family does the flute belong to?',                               options: ['Strings', 'Brass', 'Woodwinds', 'Percussion'],                                         correct: 2 },
  { question: 'What instrument family does the trumpet belong to?',                             options: ['Strings', 'Woodwinds', 'Percussion', 'Brass'],                                         correct: 3 },
  { question: 'What instrument family does the snare drum belong to?',                          options: ['Brass', 'Woodwinds', 'Strings', 'Percussion'],                                         correct: 3 },
  { question: 'What does "decrescendo" mean?',                                                  options: ['Gradually getting louder', 'Gradually getting softer', 'Suddenly loud', 'Suddenly soft'], correct: 1 },
  { question: 'What does "a cappella" mean?',                                                   options: ['Singing very loudly', 'Singing in a round', 'Singing without instruments', 'Singing softly'], correct: 2 },
  { question: 'What note gets one beat in 4/4 time?',                                           options: ['Whole note', 'Quarter note', 'Half note', 'Eighth note'],                              correct: 1 },
  { question: 'What note gets four beats in 4/4 time?',                                         options: ['Quarter note', 'Half note', 'Dotted half note', 'Whole note'],                         correct: 3 },
  { question: 'What is an "arpeggio"?',                                                         options: ['A drum pattern', 'A musical key', 'Chord notes played in sequence', 'A loud passage'],  correct: 2 },
  { question: 'What does "vivace" mean?',                                                       options: ['Lively and fast', 'Very slow', 'Getting louder', 'With sadness'],                       correct: 0 },
  { question: 'What does "moderato" mean?',                                                     options: ['Very slow', 'At a moderate tempo', 'Very fast', 'Getting louder'],                      correct: 1 },
  { question: 'Which clef is used for higher-pitched instruments?',                             options: ['Bass clef', 'Alto clef', 'Treble clef', 'Tenor clef'],                                 correct: 2 },
  { question: 'Which clef is used for lower-pitched instruments?',                              options: ['Bass clef', 'Treble clef', 'Alto clef', 'Tenor clef'],                                 correct: 0 },
  { question: 'What does "tutti" mean?',                                                        options: ['One performer solos', 'All performers play together', 'Play very softly', 'Repeat from the top'], correct: 1 },
  { question: 'What is a "coda"?',                                                              options: ['A concluding section', 'The opening theme', 'A repeated section', 'A key change'],      correct: 0 },
  { question: 'What does "dolce" mean?',                                                        options: ['Loudly', 'Sadly', 'Quickly', 'Sweetly'],                                               correct: 3 },
  { question: 'How many beats does a dotted half note get in 4/4?',                             options: ['2', '3', '4', '6'],                                                                    correct: 1 },
  { question: 'What is a pentatonic scale?',                                                    options: ['A scale with 3 notes', 'A scale with 4 notes', 'A scale with 5 notes', 'A scale with 8 notes'], correct: 2 },
  { question: 'What does "subito" mean?',                                                       options: ['Suddenly', 'Gradually', 'Softly', 'Slowly'],                                           correct: 0 },
  { question: 'What is a "chord"?',                                                             options: ['A single note', 'Two notes in sequence', 'Three or more notes played together', 'A musical rest'], correct: 2 },
  { question: 'What does "sforzando" mean?',                                                    options: ['Getting softer', 'A sudden strong accent', 'Very slow', 'Getting louder'],              correct: 1 },
  { question: 'What is the distance between two notes called?',                                 options: ['A chord', 'An arpeggio', 'An interval', 'A scale'],                                    correct: 2 },
  { question: 'What does "con brio" mean?',                                                     options: ['With sadness', 'With softness', 'With vigor', 'Very slowly'],                           correct: 2 },
  { question: 'What is solfège?',                                                               options: ['A type of instrument', 'A system using do, re, mi to sing scales', 'A musical key', 'A type of rhythm'], correct: 1 },
  { question: 'What does "tacet" mean?',                                                        options: ['Play loudly', 'Play softly', 'Be silent', 'Play quickly'],                              correct: 2 },
  { question: 'What does "D.C. al Fine" mean?',                                                 options: ['Return to start and play to Fine', 'Go to the coda', 'Repeat once', 'Play very loudly'], correct: 0 },
  { question: 'What is the lowest male singing voice?',                                         options: ['Tenor', 'Baritone', 'Bass', 'Alto'],                                                   correct: 2 },
  { question: 'What is "counterpoint"?',                                                        options: ['A very loud section', 'A type of rhythm', 'Two or more melodies played simultaneously', 'A musical rest'], correct: 2 },
  { question: 'What does "con fuoco" mean?',                                                    options: ['With sadness', 'Very slowly', 'With fire', 'Very softly'],                              correct: 2 },
  { question: 'What time signature has 3 beats per measure?',                                   options: ['2/4', '3/4', '4/4', '6/4'],                                                            correct: 1 },
  { question: 'What does a "natural" sign do?',                                                 options: ['Raises a note by a half step', 'Lowers a note by a half step', 'Cancels a sharp or flat', 'Holds the note longer'], correct: 2 },
  { question: 'According to Mr. Powell, what does practice make?',                              options: ['Perfect', 'Permanent', 'Progress', 'Problems'],                                        correct: 1 },
  { question: 'According to Mr. Powell, what is the most important skill in music?',            options: ['Speed', 'Loudness', 'Technique', 'Listening'],                                         correct: 3 },
  { question: 'How many times can /banaga be said before Mr. Powell leaves the building?',      options: ['5', '7', '8', '10'],                                                                   correct: 3 },
  { question: 'What did Mr. Powell once watch a student do with a recorder?',                   options: ['Play it upside down', 'Throw it across the room', 'Play it with their nose', 'Eat it'], correct: 2 },
  { question: 'According to Mr. Powell, when should you stop during a performance?',            options: ['When you make a mistake', 'When Mr. Powell signals', 'At the halfway point', 'Never — you finish and reflect later'], correct: 3 },
  { question: 'What does "andante" mean?',                                                      options: ['Very fast', 'Very slow', 'At a walking pace', 'With fire'],                             correct: 2 },
];
